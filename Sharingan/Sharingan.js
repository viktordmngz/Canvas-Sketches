window.onload = function(){
	...
	var color_inner = "#720202"; // inner box color - ALTERNATE RED
	
	// COLORS FOR SHARINGAN
	// var colorFirst = '#bcbcbc';
	// var colorFirst = 'Darkred';
	var colorFirst = "#720202";
		...
		function spin() {
				...
				if( spinner == 1 ){ 
					...
					if(cycle % 2 == 0){
						...
						// Trails radius change
						let tempRadius = r1;
						r1 = r2;
						r2 = tempRadius;
						delete tempRadius;

						// // Trails color change - SOLID
						// let tempTrail2 = colorTrails;
						// colorTrails = colorTrailsALT;
						// colorTrailsALT = tempTrail2;
						// delete tempTrail2;
					}
				}
